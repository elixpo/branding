...
Geometry: the 2-3 geometric shapes form a small node graph — three thin hairline #d9d9dd circles joined by thin connector lines (all nodes #d9d9dd hairline) — sitting beside and partly overlapping the panda, perfectly aligned like a workspace/org diagram, never filled otherwise. Coral and the red E-badge appear ONLY on the panda; the dots, geometric shapes and the line are #d9d9dd hairline and #212121 on white.
